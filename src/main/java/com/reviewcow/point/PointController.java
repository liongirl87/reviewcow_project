...
public class PointController {
	...
	public String managePointView(
		...
		PostPagingDTO postpaging = new PostPagingDTO(postPage, pointBo.countPointContentsByMemberId(memberId));
		
		List<Point> pointList = pointBo.getPointListByMemberIdForPaging(memberId, postpaging.getMysqlSkip() ,postpaging.getPostsperpage()); 
