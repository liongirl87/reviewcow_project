	...
	<div class="d-flex justify-content-center">
		<div class="online-product d-flex justify-content-center"><!-- w:1200px -->
			<div class="top-category-bar d-flex"><!--w:100%  -->
				<div class="top-category-child"><span>스마트스토어</span></div>
				<div class="top-category-child">쿠팡</div>
				<div class="top-category-child">옥션/지마켓</div>
				<div class="top-category-child">11번가</div>
				<div class="top-category-child">위메프</div>
				<div class="top-category-child">그외</div>
			</div>
		</div>
	</div>
	<div class="d-flex justify-content-center">	
